...
public class SinglyLL<T extends Comparable<T>> {
    ...
    public boolean insertAfter(SinglyNode nodeAfter, T valueToBeInserted) {
        ...
        SinglyNode temp = nodeAfter.next;
        nodeAfter.next = new SinglyNode(valueToBeInserted);
        nodeAfter.next.next = temp;
        size++;
        System.out.println("SUCCESS: '" + valueToBeInserted.toString()
    ...
    public SinglyNode deleteIndex(int indexToBeDeleted) {
        ...
        if (previousNode == null || previousNode.next == null) {
            System.out.println("ERROR: Index cannot be deleted as it does not exist. ");
            return null;
        }
    ...
    public void assignRandomIntegers() {
        /*
        method: adds 10 random integers in between 0 and 9
         */
        for (int i = 0; i < 10; i++) {
